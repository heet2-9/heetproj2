...
export default function FinalMessageScreen() {
  ...
  const messages = [
    ...
    "I still remember the time when we used to talk whole day without worrying about our exams 😅",
    "I hope our friendship stays strong forever, unbreakable until death parts us.!",
    ...
    "me kyare notu vicharyu notu ki ek divas aapde best friends banishu.☺",
    "but touchwood atli sari frienship toh aapda batch ma koini pan nai hoy especially opposite gender ma🧿🧿🧿",
